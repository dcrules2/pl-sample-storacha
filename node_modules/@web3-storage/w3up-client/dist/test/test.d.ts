...
export function setup(): Promise<{
    ...
    carStoreBucket: import("@web3-storage/upload-api").CarStoreBucket;
    allocationsStorage: import("@web3-storage/upload-api").AllocationsStorage;
    blobsStorage: import("@web3-storage/upload-api").BlobsStorage;
    ...
    dudewhereBucket: import("@web3-storage/upload-api").DudewhereBucket;
