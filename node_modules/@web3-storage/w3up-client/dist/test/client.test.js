...
export const testClient = {
    uploadFile: Test.withContext({
        'should upload a file to the service': async (assert, { connection, provisionsStorage, uploadTable, allocationsStorage }) => {
            ...
            assert.deepEqual(await allocationsStorage.exists(space.did(), expectedCar.cid.multihash.bytes), {
                ok: true,
            });
    ...
    uploadCar: Test.withContext({
        'uploads a CAR file to the service': async (assert, { connection, provisionsStorage, uploadTable, allocationsStorage }) => {
            ...
            assert.deepEqual(await allocationsStorage.exists(space.did(), carCID.multihash.bytes), {
                ok: true,
            });
        },
    }),
    ...
    remove: Test.withContext({
        ...
        'should not fail to remove if shard is not found': async (assert, { connection, provisionsStorage, uploadTable }) => {
