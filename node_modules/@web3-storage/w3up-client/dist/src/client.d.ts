...
export class Client extends Base {
     ...
     */
    getReceipt(taskCid: import('multiformats').UnknownLink): Promise<import("@ucanto/interface").Receipt<{}, {}, import("@ucanto/interface").Invocation<import("@web3-storage/access").Capability<import("@web3-storage/access").Ability, `${string}:${string}`, unknown>>, import("@web3-storage/access").SigAlg>>;
    /**
     ...
     */
    createDelegation(audience: import('./types.js').Principal, abilities: import('./types.js').ServiceAbility[], options?: (Omit<import("@ucanto/interface").UCANOptions, "audience"> & {
    ...
    } | undefined): Promise<BlobCapabilities.Schema.Result<{}, BlobCapabilities.Schema.Error | import("@ucanto/interface").HandlerNotFound | import("@ucanto/interface").HandlerExecutionError | import("@web3-storage/access").InvalidAudience | import("@web3-storage/access").Unauthorized>>;
    /**
